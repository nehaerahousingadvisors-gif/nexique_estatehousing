        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8 mb-8 md:mb-12">
          ...
          <div className="md:col-span-2 lg:col-span-1">
            ...
            <div className="flex space-x-2.5 md:space-x-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61591626782828" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
                style={{ backgroundColor: '#1877F2' }}>
                <svg className="w-4 h-4 md:w-5 md:h-5" fill="white" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.302 3.438 9.8 8.207 11.387v-8.04h-2.48V12h2.48V9.84c0-2.47 1.42-3.838 3.766-3.838 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.242 0-1.63.771-1.63 1.562V12h2.775l-.443 2.816h-2.332v8.04C20.566 21.873 24 17.375 24 12.073z" />
                </svg>
              </a>
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/channel/UCSMpgsR9YCW7b-aA12eNAiA" target="_blank" rel="noopener noreferrer"
                className="w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center transition-all hover:scale-110"
